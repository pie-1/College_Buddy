      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-primary-200/30">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-primary-800 font-display">Welcome Back</h1>
            <p className="text-gray-500 text-sm mt-1">Sign in to continue to CollegeBuddy</p>
          </div>
